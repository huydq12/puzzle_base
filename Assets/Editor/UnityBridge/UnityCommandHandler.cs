...
namespace UnityCopilot
{
    public static class UnityCommandHandler
    {
        ...
        // ── 15. executeMenuItem ───────────────────────────────────────
        private static string ExecuteMenuItem(SimpleJson p)
        {
            ...
            if (!executed)
            {
                throw new InvalidOperationException($"Menu item '{menuPath}' could not be executed.");
            }
